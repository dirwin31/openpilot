...
def test_router_and_settings_cache_bust_is_consistent():
  ...
  assert "/assets/components/router.js?v=router-public-path-9" in index
...
def test_public_galaxy_bootstrap_keeps_the_device_path_for_module_imports():
  ...
  assert '`${window.__theGalaxyBasePath}/assets/components/router.js?v=router-public-path-9`' in index
