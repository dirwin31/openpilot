...
//
// From yummydirtx/openpilot tools/android_auto/hardware_encoder.cc (MIT), pinned at
// 672a16f6183567c0ada53654f8527d97e1a483fa; only the include paths differ.
#include <algorithm>
#include <chrono>
#include <cstdio>
#include <cstring>
...
#include "starpilot/system/android_auto/hw/rgba_to_nv12.h"
